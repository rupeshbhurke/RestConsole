...
void NetMixRestApiTest::ApplicationAuthentication02()
{
	...
	using namespace nlohmann;
	{
		...
		_applicationAuthenticationRequest.customerServiceID = "3AXP-NZYQ-4RE6-R3ZG";
		_applicationAuthenticationRequest.productID = "MBDG 1.0";
		_applicationAuthenticationRequest.productType = "XXXXXXX";
		_applicationAuthenticationRequest.machineID = "694A3831AAAD";

		const json requestJson = _applicationAuthenticationRequest;
		std::stringstream ss;
		ss << requestJson;
